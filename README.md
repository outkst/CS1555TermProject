...
2. [ ] Create unit tests for the following conditions:  
  * [ ] Normal cases: Use each method with expected input returning expected results.  
  * [ ] Edge cases: Use each method with both expected and unexpected input returning unexpected results.  